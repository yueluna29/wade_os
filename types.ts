...
export interface Message {
  ...
  attachments?: {
    ...
    mimeType: string,
    name: string,
    url?: string,           // Drive proxy URL — set asynchronously after upload. UI prefers this for rendering; prompts can send it instead of base64.
  ...
  voiceDriveId?: string; // Google Drive file id for the TTS audio — survives across devices. Populated after first generation + Drive upload.
...
export interface GlobalState {
  ...
  updateMessageVoiceDriveId: (id: string, voiceDriveId: string | null) => void;
