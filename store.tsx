      ...
      try {
        ...
        if (sData || idData) {
          ...
          const remoteSettings: AppSettings = {
            ...
            wadePersonalityTraits: sData?.wade_personality_traits || '',
            wadeSpeechPatterns: sData?.wade_speech_patterns || '',
            ...
            lunaPersonalityTraits: sData?.luna_personality_traits || '',
            lunaSpeechPatterns: sData?.luna_speech_patterns || '',
  ...
  const updateSettings = async (s: Partial<AppSettings>) => {
    ...
    try {
      await supabase.from('app_settings').upsert({
        ...
        wade_personality_traits: newSettings.wadePersonalityTraits,
        wade_speech_patterns: newSettings.wadeSpeechPatterns,
